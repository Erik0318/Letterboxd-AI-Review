...
execSync(
  "node_modules\\.bin\\tsc.cmd src/lib/letterboxd.ts src/lib/stats.ts src/lib/utils.ts --module ES2022 --moduleResolution Bundler --target ES2022 --outDir .verify --esModuleInterop --skipLibCheck",
  { stdio: "inherit" },
);
